...
3. Set the directory where you want to clone the repository

4. Type `git clone https://github.com/lessardlab/Mapping-Ant-Species-Richness.git`

5. Hit enter

6. Done! You have cloned the repository in your computer. 
...
[link_to_data](https://www.pnas.org/doi/epdf/10.1073/pnas.1719794115)
